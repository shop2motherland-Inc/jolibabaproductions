							...
							<div class="card-content">
								...
								<div class="ev-action" {!! $evActionStyle !!}>
									...
									@else
										...
										@if(Auth::check())
											<a href="https://api.whatsapp.com/send?phone={{$post->phone}}" class="btn btn-warning btn-block">Chat On Whatsapp</a>
										{!! genPhoneNumberBtn($post, true) !!}
										{!! genEmailContactBtn($post, true) !!}
										@else
										<a  class="btn btn-warning btn-block " onclick="show_number()">Show Number</a>
											@endif
									@endif
								</div>
							</div>
