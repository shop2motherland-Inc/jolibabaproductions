					...
					<div class="category-list {{ config('settings.list.display_mode', 'make-grid') }}{{ ($contentColSm == 'col-md-12') ? ' noSideBar' : '' }}">
						...
						<div class="listing-filter">
							...
							@if (isset($posts) && $posts->count() > 0)
								...
								<div class="float-end col-md-3 col-sm-4 col-12 text-end d-none listing-view-action">
						...
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="contentAll" role="tabpanel" aria-labelledby="tabAll">
								...
								<!-- 	@if (config('settings.list.display_mode') == 'make-list')
									...
									@else -->
										@includeFirst([config('larapen.core.customizedViewPath') . 'search.inc.posts.template.gridforresult', 'search.inc.posts.template.gridforresult'])
									<!-- @endif -->
								</div>
							</div>
						</div>
