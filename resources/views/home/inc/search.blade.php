		...
		<div class="container text-center">
			...
			@if ($sForm['hideForm'] != '1')
					<form id="search" name="search" action="{{ \App\Helpers\UrlGen::search() }}" method="GET">
						<div class="row search-row animated fadeInUp d-flex justify-content-center">
							
							<div class="col-md-6 col-sm-12 search-col relative mb-1 mb-xxl-0 mb-xl-0 mb-lg-0 mb-md-0">
								<div class="search-col-inner">
									<i class="fas {{ (config('lang.direction')=='rtl') ? 'fa-angle-double-left' : 'fa-angle-double-right' }} icon-append"></i>
									<div class="search-col-input">
										<input class="form-control has-icon" name="q" placeholder="{{ 'I am looking for...' }}" type="text" value="">
									</div>
								</div>
							</div>
