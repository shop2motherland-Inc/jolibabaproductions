<?php
return;
$iconPosts = $statsOptions['icon_count_listings'] ?? 'fas fa-bullhorn';
$iconUsers = $statsOptions['icon_count_users'] ?? 'fas fa-users';
$iconLocations = $statsOptions['icon_count_locations'] ?? 'far fa-map';
$prefixPosts = $statsOptions['prefix_count_listings'] ?? '';
$suffixPosts = $statsOptions['suffix_count_listings'] ?? '';
